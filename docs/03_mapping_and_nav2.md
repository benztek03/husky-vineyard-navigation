...
ros2 launch clearpath\_viz view\_navigation.launch.py namespace:=a200\_1071
...
ros2 launch clearpath\_nav2\_demos slam.launch.py setup\_path:=$HOME/clearpath/ use\_sim\_time:=false
...
ros2 run nav2\_map\_server map\_saver\_cli -f MAPNAME \\

&#x20; --ros-args -p map\_subscribe\_transient\_local:=true -r 
...
ros2 launch clearpath\_nav2\_demos localization.launch.py \\

&#x20; setup\_path:=$HOME/clearpath/ \\

&#x20; use\_sim\_time:=false \\

&#x20; map:=$HOME/maps/my\_map\_name.yaml
...
ros2 launch clearpath\_nav2\_demos nav2.launch.py \\
